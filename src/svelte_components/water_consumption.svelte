...
<div class="water-intake">
    ...
    <div class="water-buttons">
        <button on:click={() => setWaterIntake(0)}> 8 oz / 1 Liter </button>
        <button on:click={() => setWaterIntake(1)}> 32 oz / 2 Liter </button>
        <button on:click={() => setWaterIntake(2)}> 68 oz / 3 Liter </button>
        <button on:click={() => setWaterIntake(3)}> 102 oz / 4 Liter </button>
        <button on:click={() => setWaterIntake(4)}> 136 oz / 5 Liter </button>
    </div>
</div>
